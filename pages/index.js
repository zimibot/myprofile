...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-3 flex-1 gap-4 p-4 bg-black bg-opacity-30 backdrop-blur-sm">
      ...
      <div className="bg-slate-200 dark:bg-slate-800 px-6 py-8 ring-1 ring-slate-900/5 hover:border-rose-500 hover:border-2  hover:shadow-black transition-all z-10 hover:scale-105">
